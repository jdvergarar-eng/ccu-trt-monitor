...
class TRTClient:
    ...
    def _fetch_trucks_from_api(self, site_config: dict) -> List[TruckInPlant]:
        ...
        #
        # Esto maneja dos tipos de datos inconsistentes en Safecard:
        #  a) OUT registrado bajo una patente distinta en el mismo viaje.
        #  b) Viajes antiguos con IN huérfano de un camión que ya salió.
